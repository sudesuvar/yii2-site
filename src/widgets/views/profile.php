...
<li class="nav-item dropdown me-lg-0 ">
    <a href="#"class="nav-link dropdown-toggle profile flex-column" data-bs-toggle="dropdown"  aria-expanded="false"style="paadding-bottom:0px!important;margin-bottom:0px;padding-top:0px!important">
        <?php if ($model !== null) : ?>
