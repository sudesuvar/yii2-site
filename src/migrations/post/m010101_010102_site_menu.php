...
class m010101_010102_site_menu extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('menu_item', ['id_item', 'label', 'slug', 'type', 'style', 'data', 'sort', 'id_menu', 'name_auth', 'id_user', 'date_create', 'date_update'], [
            ...
            [NULL,'Profile','profile-site','2','{"icon":"fa-user","color":"","iconSize":"","display":"3","childDisplay":false}','{"data":{"module":"site","routeType":"action","route":"/site/profile/edit","model":"","menuRoute":null,"menuType":"web"}}',2,2,'',1,'2022-06-14 13:35:40','2022-06-14 13:35:40'],
