...
class m010101_010102_site_menu extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('menu_item', ['id_item', 'label', 'slug', 'type', 'style', 'data', 'sort', 'id_menu', 'name_auth', 'id_user', 'date_create', 'date_update'], [
            ...
            [NULL, 'Preference', 'preference', '2', '{"icon":"","color":"","iconSize":"","display":"","childDisplay":false}', '{"data":{"module":"site","routeType":"action","route":"\\/site\\/preference\\/index","model":null,"menuRoute":null,"menuType":"web"}}', 3, $id_menu, 'siteWebPreferenceIndex', 1,'2022-06-14 13:34:12', '2022-06-14 13:34:12'],
